    ...
    class Program : ProgramMain
    {
        ...
        * ===================================================================================== */
        ...
        static void Main(string[] args)
        {
            ...
            int start_position = 53306;
            //max - 260484 
            int fields_count = 260484;
            ...
            { 
                ...
                while (data.Read())
                {
                    ...
                    */
                    ...
                    insertTo(conWrite, "turas", "turuz_charak", "tid", tid, "chid", "18", "val", value, "val_prid", val_prid);

                    values = getCharakByNameAndKodas("Locations", arrival_location_id);
                    value = values[0]; val_prid = values[1];
                    insertTo(conWrite, "turas", "turuz_charak", "tid", tid, "chid", "20", "val", value, "val_prid", val_prid);

                    values = getCharakByNameAndKodas("Rooms", room_group_id);
                    value = values[0]; val_prid = values[1];
                    insertTo(conWrite, "turas", "turuz_charak", "tid", tid, "chid", "24", "val", value, "val_prid", val_prid);

                    values = getCharakByNameAndKodas("Accommodations", accom_id);
                    value = values[0]; val_prid = values[1];
                    insertTo(conWrite, "turas", "turuz_charak", "tid", tid, "chid", "25", "val", value, "val_prid", val_prid);

                    values = getCharakByNameAndKodas("Boarding groups", board_group_id);
                    value = values[0]; val_prid = values[1];
                    insertTo(conWrite, "turas", "turuz_charak", "tid", tid, "chid", "26", "val", value, "val_prid", val_prid);

                    insertTo(conWrite, "turas", "turuz_charak", "tid", tid, "chid", "21", "val", begin_date);
                    insertTo(conWrite, "turas", "turuz_charak", "tid", tid, "chid", "22", "val", end_date);
                    insertTo(conWrite, "turas", "turuz_charak", "tid", tid, "chid", "23", "val", duration);
